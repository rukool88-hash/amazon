...
const plans = [
  { name: "试运行包", credits: 500, price: "手工录入", note: "适合首版内部试跑" },
  { name: "运营包", credits: 2000, price: "手工录入", note: "适合小规模运营" },
  { name: "团队包", credits: 5000, price: "手工录入", note: "适合稳定队列压测" },
];
    ...
    <AppShell title="积分与套餐">
      <section className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
        <div className="glass-panel rounded-[32px] p-6">
          ...
          <h2 className="mt-4 text-4xl font-semibold">1,280</h2>
          <p className="mt-2 text-sm text-[var(--muted)]">其中 160 积分预留中，460 积分已消耗。</p>
